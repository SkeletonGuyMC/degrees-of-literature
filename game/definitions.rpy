...
define mu = DynamicCharacter('mu_name', image='mother', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define t = DynamicCharacter('t_name', image='naoki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define l = DynamicCharacter('l_name', image='lemon', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
