...
define -2 text_outline_color = "#833091"
...
style window:
    ...
    background Transform("mod_assets/mod_textbox.png", xalign=0.5, yalign=1.0)
...
style namebox:
    ...
    background Frame("mod_assets/mod_namebox.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
style game_menu_outer_frame:
    ...
    background recolorize("gui/overlay/game_menu.png", blackCol="#d240e4", whiteCol="#fbc4f8")
