...
define config.name = "Degrees Of Literature"
...
define build.name = "DegreesOfLiterature"
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DegreesOfLiterature"
