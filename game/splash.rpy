...
image menu_bg:
    topleft
    "gui/menu_bg.png"
    recolorize("gui/menu_bg.png", "#e04af3", "#fbdbf6", 1)
    menu_bg_move
...
image menu_art_l:
    subpixel True
    "mod_assets/menu_art_lm.png"
    xcenter 1160
    ycenter 375
    zoom 0.5
    menu_art_move(0.54, 200, 0.35)
...
image menu_art_m:
    ...
    ycenter 640
    zoom 1.00
    menu_art_move(1.00, 1000, 0.90)

image menu_art_t:
    subpixel True
    "mod_assets/menu_art_t.png"
    xcenter 1100
    ycenter 60
    zoom 1.00
    menu_art_move(1.00, 500, 0.3)
...
image menu_nav:
    ...
    recolorize("gui/overlay/main_menu.png", "#d240e4", "#fbc4f8")
    menu_nav_move
